<x-form title="Welcome back" subtitle="Sign in to your account to continue voting">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" data-test="log-in-button" class="w-full h-11 bg-primary-dark text-primary-subtle rounded-lg text-sm font-medium mt-2 hover:bg-text-on-primary transition-colors">
            Log In
        </button>
